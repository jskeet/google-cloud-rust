...
impl ListBucketsRequest {
    ...
    /// ```ignore,no_run
    /// # use google_cloud_storage::model::ListBucketsRequest;
    /// let x = ListBucketsRequest::new().set_return_partial_success(true);
    /// ```
...
impl ListBucketsResponse {
    ...
    /// ```ignore,no_run
    /// # use google_cloud_storage::model::ListBucketsResponse;
    /// let x = ListBucketsResponse::new().set_unreachable(["a", "b", "c"]);
    /// ```
...
impl ObjectChecksums {
    ...
    /// ```ignore,no_run
    /// # use google_cloud_storage::model::ObjectChecksums;
    /// let x = ObjectChecksums::new().set_or_clear_crc32c(Some(42_u32));
